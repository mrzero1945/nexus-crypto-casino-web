        ...
        return(
            <div className="container text-white mt-md-5" >
                ...
                <div className="row justify-content-center align-items-center">
                    <div className="col-md-6 me-5 px-md-4 py-md-4">
                    ...
                    <div className="col-md-4 me-5 d-flex flex-column align-items-center justify-content-center" style={{ height: "100%" }}>
                        <button className="btn text-white mt-5 " style={{ background: "#59BE43", borderRadius: "15px" }}>
                        ...
                        <button className="btn text-white mt-md-2 px-md-3 mb-md-5" style={{ background: "#59BE43", borderRadius: "15px" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="col-md-11 mt-md-5 px-md-4 py-md-4">
